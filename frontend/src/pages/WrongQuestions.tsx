  ...
  const columns = [
    {
      ...
      render: (value: string) => (
        <span 
          ...
          style={{ fontFamily: '"MarukoGothicCJKsc-Medium", "Nunito", sans-serif' }}
        >
          {value}
        </span>
      ),
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-cover bg-center px-4 py-8" style={{ backgroundImage: 'url(/common-bg.png)' }}>
      ...
      <div className="relative w-full max-w-5xl mx-auto pt-16">
        {/* 装饰元素 */}
        <div className="absolute -top-6 -right-10 w-40 h-40 text-[#f5c31c]/10 -rotate-12 pointer-events-none">
           <Icon name="critterpedia" size={160} fill="currentColor" stroke="none" />
        </div>
        
        {/* 主内容卡片 */}
        <Card 
          className="relative !rounded-[50px] !border-[8px] !border-white !p-8 sm:!p-12 shadow-[0_20px_0_0_rgba(107,92,67,0.08)]"
        ...
        >
          ...
          <div className="text-center mb-10">
            <div className="inline-block relative">
               <h1 
                 ...
                 style={{ fontFamily: '"MarukoGothicCJKsc-Bold", "Nunito", sans-serif' }}
               >
                 错题本
               </h1>
            ...
            <div className="mt-4 text-xl sm:text-2xl font-black text-[#9f927d] bg-white/40 py-2 px-8 rounded-full inline-block border-2 border-white/50">
          ...
          {questions.length > 0 && (
            <div className="absolute -top-14 -left-8 w-32 h-32 sm:w-44 sm:h-44 npc-float z-10">
              <img 
                src="/Blathers.webp" 
                alt="角色" 
